      ...
      <div className="centerer home-container">
        <div className="all-page-backbone">
          ...
          <div className="headings-all">
            <h2>All of your online ads</h2>
            <p>
              This page displays all of your online ads, you can choose to edit,
              remove or visit your ads from this page
            </p>
          </div>
